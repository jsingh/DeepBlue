<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<DeepBlue.Models.Report.ExportDealDetailModel>" %>
<%Html.RenderPartial("DealDetailReport", Model.DealDetailReportModel);%>
