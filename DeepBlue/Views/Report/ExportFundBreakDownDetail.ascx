<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<DeepBlue.Models.Report.ExportFundBreakDownDetailModel>" %>
<%Html.RenderPartial("FundBreakDownReport", Model.FundBreakDownReportDetail);%>
