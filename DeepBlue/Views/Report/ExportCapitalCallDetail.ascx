<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<DeepBlue.Models.Report.ExportCapitalCallDetailModel>" %>
<%Html.RenderPartial("CapitalCallSummaryReport", Model.CapitalCallReportDetail);%>
