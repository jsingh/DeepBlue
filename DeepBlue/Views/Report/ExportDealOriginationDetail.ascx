<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<DeepBlue.Models.Report.ExportDealOriginationModel>" %>
<%Html.RenderPartial("DealOriginationReport", Model.DealOriginationReportModel);%>
