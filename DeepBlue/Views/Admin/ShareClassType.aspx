...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<div class="admin-main">
		<div class="admin-header">
			<a href="javascript:shareclasstype.add(0);">
...
<asp:Content ID="Content4" ContentPlaceHolderID="BottomContent" runat="server">
	<%=Html.jQueryFlexiGrid("ShareClassTypeList", new FlexigridOptions { ActionName = "ShareClassTypeList", ControllerName = "Admin", HttpMethod = "GET", SortName = "ShareClassTypeID", Paging = true })%>
</asp:Content>