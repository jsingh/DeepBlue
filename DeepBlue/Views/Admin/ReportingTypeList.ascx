<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<IList<DeepBlue.Models.Entity.ReportingType>>" %>
...
<% flexData.total = Convert.ToInt32(ViewData["TotalRows"]);
   ...
   foreach (var item in Model) {
	   ...
	   row.cell.Add(item.ReportingTypeID.ToString());
	   row.cell.Add(item.Reporting);
