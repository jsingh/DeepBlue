...
<asp:Content ID="Content4" ContentPlaceHolderID="BottomContent" runat="server">
	...
	<%= Html.jQueryFlexiGrid("FundDetail", new FlexigridOptions {	ActionName = "CapitalDistributionDetailList", ControllerName = "CapitalCall", Autoload = false, SortName = "CapitalDistributionID", SortOrder = "desc",	HttpMethod = "Get", Paging = true, Height = 480, Width=600, BoxStyle=false })%>
