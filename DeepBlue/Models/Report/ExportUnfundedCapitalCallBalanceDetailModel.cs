...
namespace DeepBlue.Models.Report {
	public class ExportUnfundedCapitalCallBalanceDetailModel {
		...
		public List<UnfundedCapitalCallBalanceReportDetail> UnfundedCapitalCallBalanceReportDetails { get; set; }
	}
}