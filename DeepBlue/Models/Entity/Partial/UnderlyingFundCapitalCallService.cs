...
namespace DeepBlue.Models.Entity {
	public interface IUnderlyingFundCapitalCallService {
		void SaveUnderlyingFundCapitalCall(UnderlyingFundCapitalCall underlyingFundCapitalCall);
	}
	public class UnderlyingFundCapitalCallService : IUnderlyingFundCapitalCallService {

		#region IUnderlyingFundCapitalCallService Members
