...
namespace DeepBlue.Models.Deal {
	...
	public class DealUnderlyingDetail {
		...
		public string TotalFundNAV { get { return FormatHelper.CurrencyFormat(this.DealUnderlyingFunds.Sum(fund => fund.FundNAV)); } }
		...
		public string TotalGrossPurchasePrice { get { return FormatHelper.CurrencyFormat(this.DealUnderlyingFunds.Sum(direct => direct.GrossPurchasePrice)); } }
