var underlyingFundNAVReport={
	...
	,onSubmit: function (frm) {
		try {
			...
			target.show();
			var grid=$("#UnderlyingFundNAVList");
			grid.flexRemoveSortClass();
			grid.flexOptions({ sortname: "" });
			underlyingFundNAVReport.onGridInit();
	...
	,exportData: function () {
		...
		if(exportTypeId=="1"||exportTypeId=="4") {
			...
			url="/Report/ExportUnderlyingFundNAVDetail?UnderlyingFundId="+$("#UnderlyingFundId").val()+"&ExportTypeId="+exportTypeId;
