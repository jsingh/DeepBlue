...
(function ($) {
	...
	function progress(e) {
		if(e.lengthComputable) {
			...
			opts.progressUpdated(this.index,this.file,70);
		}
	}
	...
	function upload() {
		...
		files_count=$(".preview",_target).length;
	...
	function beforeEach(file,index) {
		return opts.beforeEach(file,index);
	}
	...
	function beforeSend() {
		var data=opts.beforeSend();
		opts.data=data;
	}

	function beforeValid() {
		return opts.beforeValid();
	}
