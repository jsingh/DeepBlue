...
namespace DeepBlue.Tests.Controllers.Member {
    public class MemberBase : Base {
        ...
        public Mock<IMemberRepository> MockRepository { get; set; }
        ...
        public override void Setup() {
            ...
            MockRepository = new Mock<IMemberRepository>();
        ...
        private List<AddressType> GetAddressTypes() {
            ...
            Array values = Enum.GetValues(typeof(DeepBlue.Models.Member.Enums.AddressType));
            
            foreach (var i in values) {
                int val = (int)i;
                addressTypes.Add(new AddressType {
                    AddressTypeName = Enum.GetName(typeof(DeepBlue.Models.Member.Enums.AddressType), val),
                    AddressTypeID = val
                });
            }
