...
namespace DeepBlue.Tests.Controllers.Deal {
    public class CreateDealDocumentValidData : CreateDealDocument  {
		...
		[Test]
		public void valid_Deal_entityid_sets_model_error_on_model_state() {
			Assert.IsTrue(test_posted_value("EntityID"));
		}

		[Test]
		public void valid_Deal_entityid_sets_1_error() {
