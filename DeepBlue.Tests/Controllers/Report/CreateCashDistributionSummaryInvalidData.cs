...
namespace DeepBlue.Tests.Controllers.Report {
	public class CreateCashDistributionSummaryInvalidData : CreateCashDistributionSummary {
        ...
        private void SetFormCollection() {
			...
			base.ActionResult = base.DefaultController.CashDistributionSummary ();
        }
        ...
        [Test]
        public void invalid_Report_cashdistributionsummary_fundid_sets_model_error_on_model_state() {
			Assert.IsFalse(test_posted_value("FundId"));
        }

        [Test]
        public void invalid_Report_cashdistributionsummary_fundid_sets_1_error() {
			Assert.IsTrue(test_error_count("FundId", 1));
        }

		[Test]
		public void invalid_Report_cashdistributionsummary_capitalDistributionid_sets_model_error_on_model_state() {
			Assert.IsFalse(test_posted_value("CapitalDistributionId"));
		}

		[Test]
		public void invalid_Report_cashdistributionsummary_capitalDistributionid_sets_1_error() {
			Assert.IsTrue(test_error_count("CapitalDistributionId", 1));
		}
        #endregion
        ...
        private FormCollection GetInvalidformCollection() {
			...
			formCollection.Add("CapitalDistributionId", string.Empty);
