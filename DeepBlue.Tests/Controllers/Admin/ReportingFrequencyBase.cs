...
namespace DeepBlue.Tests.Controllers.Admin {
    public class ReportingFrequencyBase : Base {
        ...
        public override void Setup() {
			...
			MockAdminRepository.Setup(x => x.GetAllShareClassTypes(1, 1, "ReportingFrequencyID", "asc", ref totalRows)).Returns(new List<DeepBlue.Models.Entity.ShareClassType>());
        }
