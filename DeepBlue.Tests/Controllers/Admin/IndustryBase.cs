...
namespace DeepBlue.Tests.Controllers.Admin {
    public class IndustryBase : Base {
        ...
        public override void Setup() {
			...
			MockAdminRepository.Setup(x => x.GetAllIndustrys(1, 1, "IndustryID", "asc", ref totalRows)).Returns(new List<DeepBlue.Models.Entity.Industry>());
        }
