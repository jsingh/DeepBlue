...
namespace DeepBlue.Tests.Controllers.Admin {
    public class InvestorEntityTypeBase : Base {
        ...
        public override void Setup() {
			...
			MockAdminRepository.Setup(x => x.GetAllInvestorEntityTypes(1, 1, "InvestorEntityTypeName", "asc", ref totalRows)).Returns(new List<DeepBlue.Models.Entity.InvestorEntityType>());
        }
