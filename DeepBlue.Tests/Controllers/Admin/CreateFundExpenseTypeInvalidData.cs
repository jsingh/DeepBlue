...
namespace DeepBlue.Tests.Controllers.Admin {
    public class CreateFundExpenseTypeInvalidData : FundExpenseTypeBase {
        ...
        private void SetFormCollection() {
			...
			base.ActionResult = base.DefaultController.UpdateFundExpenseType(GetInvalidformCollection());
        }
        ...
        [Test]
        public void invalid_fundexpensetype_fundexpensetypename_sets_model_error_on_model_state() {
            Assert.IsFalse(test_posted_value("Name"));
        }

        [Test]
        public void invalid_fundexpensetype_fundexpensetypename_sets_1_error() {
			Assert.IsTrue(test_error_count("Name", 1));
        }

        [Test]
        public void invalid_fundexpensetype_fundexpensetypename_results_in_invalid_modelstate() {
            SetFormCollection();
