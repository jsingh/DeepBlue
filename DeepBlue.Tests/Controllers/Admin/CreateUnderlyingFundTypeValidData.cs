...
namespace DeepBlue.Tests.Controllers.Admin {
    public class CreateUnderlyingFundTypeValidData : UnderlyingFundTypeBase {
        ...
        public override void Setup() {
            // Arrange
            base.Setup();
            // Test if the SaveUnderlyingFundType call fails
            MockAdminRepository.Setup(x => x.SaveUnderlyingFundType(It.IsAny<DeepBlue.Models.Entity.UnderlyingFundType>())).Returns(new List<Helpers.ErrorInfo>());
        }

        private void SetFormCollection() {
            base.DefaultController.ValueProvider = SetupValueProvider(GetValidformCollection());
            base.ActionResult = base.DefaultController.UpdateUnderlyingFundType(GetValidformCollection());
        }
        ...
        [Test]
        public void returns_back_to_new_view_if_saving_underlyingfundtype_failed() {
            SetFormCollection();
