...
namespace DeepBlue.Tests.Controllers.Admin {
    public class CreateCommunicationTypeInvalidData : EditCommunicationType {
        ...
        private void SetFormCollection() {
			...
			base.ActionResult = base.DefaultController.UpdateCommunicationType(GetInvalidformCollection());
        }
        ...
        private FormCollection GetInvalidformCollection() {
			...
			formCollection.Add("CommunicationTypeName", string.Empty);
			formCollection.Add("CommunicationGroupId", string.Empty);
