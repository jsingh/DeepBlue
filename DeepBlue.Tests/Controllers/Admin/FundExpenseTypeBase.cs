...
namespace DeepBlue.Tests.Controllers.Admin {
    public class FundExpenseTypeBase : Base {
        ...
        public override void Setup() {
			...
			MockAdminRepository.Setup(x => x.GetAllFundExpenseTypes(1, 1, "Name", "asc", ref totalRows)).Returns(new List<DeepBlue.Models.Entity.FundExpenseType>());
        }
		...
		#region FindFundExpenseType
		[Test]
		public void valid_find_fundexpensetype_sets_json_result_error() {
			Assert.IsTrue((DefaultController.FundExpenseTypeList(1,1,"Name","asc") != null));
		}
		#endregion
    }
}
