...
namespace DeepBlue.Tests.Controllers.Admin {
    public class FixedIncomeTypeBase : Base {
        ...
        public override void Setup() {
			...
			MockAdminRepository.Setup(x => x.GetAllFixedIncomeTypes(1, 1, "FixedIncomeTypeID", "asc", ref totalRows)).Returns(new List<DeepBlue.Models.Entity.FixedIncomeType>());
        }
