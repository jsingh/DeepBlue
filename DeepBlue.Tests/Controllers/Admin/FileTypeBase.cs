...
namespace DeepBlue.Tests.Controllers.Admin {
    public class FileTypeBase : Base {
        ...
        public override void Setup() {
			...
			MockAdminRepository.Setup(x => x.GetAllFileTypes(1, 1, "FileTypeID", "asc", ref totalRows)).Returns(new List<DeepBlue.Models.Entity.FileType>());
        }
