...
namespace DeepBlue.Tests.Models.CapitalCall {
    public class CapitalCallManualTest : Base {
        public DeepBlue.Models.Entity.CapitalCall  DefaultCapitalCallManual { get; set; }
        ...
        public override void Setup() {
			...
			DefaultCapitalCallManual = new DeepBlue.Models.Entity.CapitalCall(MockService.Object);
